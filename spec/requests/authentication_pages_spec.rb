...
describe "Authentication" do
  ...
  describe "signin" do
      ...
      it { should have_link('Users',    href: users_path) }
  	  ...
  	  # Ensure that the <a> tag has the right 'href' attribute.In this case, check if there is a link to the user's profile page
      ...
      describe "for non-signed-in users" do
        ...
        describe "in the Users controller" do
          ...
          describe "submitting to the update action" do
            # Submit an HTTP PUT request to test if the update action works
            before { put user_path(user) }

            # Check that the server's response redirects the user to the Sign in page
            specify { response.should redirect_to(signin_path) }
          end
